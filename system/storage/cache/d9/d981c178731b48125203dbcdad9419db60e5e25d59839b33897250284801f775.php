...
class __TwigTemplate_8ab528865f1ebc43d3eef95862d4bf427774b206f4500c67aa909f24e22f4afd extends Twig_Template
{
...
/*           <label>*/
/*             <input type="radio" name="customer_group_id" value="{{ customer_group.customer_group_id }}" class="form-check-input" checked="checked" />*/
...
/*           <div class="form-check"> {% if guest_custom_field[custom_field.custom_field_id] and custom_field_value.custom_field_value_id == guest_custom_field[custom_field.custom_field_id] %}*/
/*             <label>*/
...
/*         <label class="col-form-label">{{ custom_field.name }}</label>*/
/*         <br />*/
/*         <button type="button" id="button-payment-custom-field{{ custom_field.custom_field_id }}" data-loading-text="{{ text_loading }}" class="btn btn-light"><i class="fa fa-upload"></i> {{ button_upload }}</button>*/
